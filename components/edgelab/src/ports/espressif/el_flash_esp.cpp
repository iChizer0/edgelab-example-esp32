...
static int init(void) {
    ...
    esp_partition_type_t    ep0       = static_cast<esp_partition_type_t>(0x40);
    esp_partition_subtype_t ep1       = static_cast<esp_partition_subtype_t>(0x00);
    partition = esp_partition_find_first(ep0, ep1, "flashdb");
